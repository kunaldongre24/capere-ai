...
or profileConnectionConfirmed is true. Social profiles are supplemental GoHighLevel metadata and must
not be described as Google Business Profile fields.`;
